...
public class ConnectOracleUsingSpringHibernateInJavaApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(ConnectOracleUsingSpringHibernateInJavaApplication.class, args);
	}
